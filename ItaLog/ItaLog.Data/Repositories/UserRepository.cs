...
namespace ItaLog.Data.Repositories
{
    public class UserRepository :  IUserRepository
    {
        ...
        public UserRepository(ItaLogContext contexto)
        {
            _contexto = contexto;
        }
        ...
        {
            return _contexto.Users.FirstOrDefault(user => user.Email == email);
        }
        ...
        {
            return _contexto.Users.FirstOrDefault(user => user.Id == id);
        }
